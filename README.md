...
Web based list of Custom ROMs for the Poco F3 (aka Xiaomi Mi 11x aka Redmi K40). This page is now an Angular web application. With PR #3, we have conducted a complete redesign and relaunch of the page. Includes a filter function and an about page. Supports light and dark mode. Please take note of the [criteria for inclusion](https://github.com/desperateCoder/alioth/blob/master/CONTRIBUTING.md#criteria-for-inclusion).
